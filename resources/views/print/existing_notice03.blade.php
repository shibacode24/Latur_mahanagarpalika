  ...
  <div style="width:100%;font-size:15px">
    ...
    <table width="100%" >
      <tr>
        ...
        <td width="70%">    <h1 align="center">लातूर शहर महानगर पालिका </br> लातूर <br> <spam style="margin-left: 21%;"> </spam></h1></td>
      </tr>
    </table>
  ...
  <table width="90%" style="  border: 1px solid;" >
   ...
   @endif
    ...
    <td style="  border: 1px solid black;text-align: center;">
     ...
     {{ ( ($data->reg_fee + $data->charges) +  ($data->reg_fee) +  ($data->late_fee) * ($data->past_year + $data->certificate_year)) }}
     @endif
