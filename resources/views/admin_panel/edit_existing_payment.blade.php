                ...
                <div class="col-md-10 mx-auto">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <form class="row g-2" method="post" action="{{ route('update_existing_payment') }}">
                                @csrf
                                ...
                                <div class="col-md-2">
                                    ...
                                    <select class="form-select mb-3 location" aria-label="Default select example"
                                        ...
                                        <option value="1" @if ($edit_data->certificate_year == '1')selected 
                                            @endif>1 Year</option>
                                        <option value="2" @if ($edit_data->certificate_year == '2')selected 
                                            @endif>2 Year</option>
                                        <option value="3" @if ($edit_data->certificate_year == '3')selected 
                                            @endif>3 Year</option>
                                    </select>
                                </div>
                                <div class="col-md-2">
