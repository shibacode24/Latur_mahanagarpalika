...
<table width="100%" border="none">
  ...
  <tr>
    ...
    <td colspan="2">&nbsp;{{$data->type_of_bussiness_id=='Hotel' ?$data->type_of_bussiness_id : '' }}  {{ $data->bussiness_type1 }}
      <br/>&nbsp;
