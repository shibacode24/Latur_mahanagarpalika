        ...
        <div class="stl_view">
            <div class="stl_05 stl_06">
                ...
                <div class="stl_01" style="left:6.252em;top:6.9922em;"><span class="stl_13 stl_08 stl_14"
                        style="word-spacing:-0.0014em;">लातूरवाघाळा शहर महानगरपालिका </span><span
...
<body style="font-family:Arial;font-size:12px">
  ...
  <table>
    <tr>
      ...
      <td style="width:80%">
        <h4>नादेड शहर  महानगर पालिका नादेड </h4>
    ...
    <div
        ...
        <table>
            <tr>
                <td> <img src="{{ asset('images/img_01.png') }}" style="width:20%;height:40%"></td>
                <td style="width:80%">
                    <h4>लातूर शहर महानगर पालिका लातूर</h4>
                    <h5 style="color: #4c4b4b;">Trade License Deparment</h5>
                </td>
            </tr>
        </table>
        <hr style="color: #000;">
