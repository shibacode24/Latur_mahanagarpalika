                    ...
                    <div class="card" style="margin-top:-4%;">
                        ...
                        <div class="card-body">
                            <div class="card-title d-flex align-items-center">
                                ...
                                <h6 style="color:red;font-weight:bold">Business Registration Type</h6>
                            </div>
                            <hr>
                            <form class="row g-2" method="post" action="{{ route('bussinessupdate') }}">
                                ...
                                <div class="col-md-3">
                                    ...
                                    <input class="form-control mb-3 from-text" type="text"
                                        placeholder="Business Registration" name="bussiness_reg_type"
                                        value="{{ $edit_data->bussiness_reg_type }}">

                                </div>
                                <div class="col-md-3">
                                    <label>Business Reg.Type</label>
                                    <input class="form-control mb-3 to-text" type="text"
                                        placeholder="Business Registration" name="bussiness_reg_type1"
                                        value="{{ $edit_data->bussiness_reg_type1 }}">
                                    ...
                                    <tbody>
                                        @foreach ($bussiness_all as $bussiness_all)
                                            <tr>
                                                ...
                                                <td><a href="{{ route('bussinessedit', $bussiness_all->id) }}"><button
                                                            type="button" class="btn1 btn-outline-success"><i
                                                                class='bx bx-edit-alt me-0'></i></button></a> <a
                                                        href="{{ route('bussinessdelete', $bussiness_all->id) }}"><button
