                            ...
                            <form class="row g-2" method="post" action="{{ route('bussinessinsert') }}">
                                ...
                                <div class="col-md-3">
                                    ...
                                    <input class="form-control mb-3 from-text" type="text"
                                        placeholder="Business Registration" name="bussiness_reg_type" required>
                                ...
                                <div class="col-md-3">
                                    ...
                                    <input class="form-control mb-3 to-text" type="text"
                                        placeholder="व्यवसाय नोंदणी प्रकार" name="bussiness_reg_type1">
                                    ...
                                    <tbody>
                                        @foreach ($bussiness_all as $bussiness_all)
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="{{ route('bussinessedit', $bussiness_all->id) }}"><button
