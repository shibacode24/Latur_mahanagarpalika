					...
					<div class="card-body">
						...
						<form class="row g-2" method="post" action="{{ route('typeoflicenceinsert') }}">
							...
							<div class="col-md-4">
								...
								<input class="form-control mb-3" type="text" name="type_of_licence"placeholder="Licence Type" required>
								
							</div>

								<div class="col-md-4">
								<label>Licence no</label>
								<input class="form-control mb-3" type="text" name="licence_no" placeholder="Licence No" required>
