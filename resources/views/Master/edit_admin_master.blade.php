			...
			<div class="page-content">
				...
				<div class="card" style="margin-top:-4%;">
					...
					<div class="card-body">
						...
						<hr>
						<form class="row g-2" method="post"   enctype="multipart/form-data" action="{{ route('adminupdate') }}">
							@csrf
							...
							<div class="col-md-2">
								...
								<select class="form-select mb-3" aria-label="Default select example" name="role">
									...
									<option value="1" @if ($edit_data->role == '1') selected @endif>Admin</option>
									<option value="2" @if ($edit_data->role == '2') selected @endif>Employee</option>
								</select>
							</div>
							...
							<div class="col-md-2">
								...
								<select class="form-select mb-3" aria-label="Default select example" name="zone_id">
									...
									<option value="{{ $zone->id }}" @if ($edit_data->zone_id == $zone->id) selected  @endif>{{ $zone->zone }}
									</option>
								@endforeach
								</select>
							</div>
							...
							<div class="col-md-2">
								...
								<input class="form-control mb-3" type="text" placeholder="UserName"
									aria-label="default input example" name="username" value="{{ $edit_data->username }}">
							</div>
