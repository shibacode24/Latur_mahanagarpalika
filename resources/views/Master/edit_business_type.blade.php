			...
			<div class="row" style="margin-left:-21%;">
				...
				<div class="card" style="margin-top:-4%;">
					...
					<div class="card-body">
						...
						<hr>
						<form class="row g-2" method="post" action="{{ route('new_bussinessupdate') }}">
							@csrf
							...
							<div class="col-md-4">
								...
								<input class="form-control mb-3 from-text" type="text" placeholder="Business Type" name="business_type" value="{{ $edit_data->business_type }}" required>
								
							</div>

							<div class="col-md-4">
								<label>Business Type</label>
								<input class="form-control mb-3 to-text" type="text" placeholder="व्यवसाय  प्रकार" name="business_type1" value="{{ $edit_data->business_type1 }}">
